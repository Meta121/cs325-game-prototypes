...
window.onload = function() {
	...
	game.state.add( "main_level_7", make_main_game_level_7_state(game) ); //Level 7
	game.state.add( "main_level_8", make_main_game_level_8_state(game) ); //Level 8
	game.state.add( "main_level_final_boss", make_main_game_level_final_boss_state(game) ); //Level Final Boss Level
...
function make_end_state(game)
{
	...
	function restartGame() { //test
		...
		//game.state.start('main_level_final_boss');
...
function make_main_game_level_3_state( game )
{
    function preload() {
...
function make_main_game_level_4_state( game )
{
    function preload() {
...
//--End of level code--
function make_main_game_level_5_state( game )
{
    function preload() {
...
//--End of level code--
function make_main_game_level_6_state( game )
{
    function preload() {
	...
	*/
	function collisionPlayer_and_ExitBox (player, exit_box) {
		...
		game.state.start( "main_level_7" ); //test ////Goes to level 7
		//game.state.start( "main_level_8" ); //test ////Goes to level 8
		//game.state.start( "main_level_final_boss" ); //test ////Goes to level Final Boss Level
		//game.state.start( "victory_end" ); //test //Goes to the victory screen
...
//--End of level code--
function make_main_game_level_7_state( game )
{
    function preload() {
    ...
    function create() {
		...
		*/
		...
		enemy_1 = new createSingleGroundEnemy_1(1, game, 71 * 16, 68 * 16); //test
		enemy_2 = new createSingleGroundEnemy_1(2, game, 48 * 16, 70 * 16); //test
		enemy_3 = new createSingleGroundEnemy_1(3, game, 43 * 16, 60 * 16); //test
		enemy_4 = new createSingleGroundEnemy_1(4, game, 50 * 16, 48 * 16); //test
		enemy_5 = new createSingleGroundEnemy_1(5, game, 13 * 16, 36 * 16); //test
...
//--End of level code--
function make_main_game_level_8_state( game )
{
    function preload() {
    ...
    function create() {
		...
		*/
		...
		exit_box_1 = new createExitBox(11, game, 47 * 16, 46 * 16); //test //Level 8 Exit Box
...
//--End of level code--
function make_main_game_level_final_boss_state( game )
{
    function preload() {
	...
	*/
	function createSingleBossEnemy_Head_1 (index, game, x, y) //test //My version
	{
		...
		this.enemy.animations.add('neutral', [0, 1], 10, true); //test
		this.enemy.animations.play('neutral'); //test
