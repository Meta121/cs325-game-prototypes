...
function make_main_game_state( game )
{
    ...
    function create() {
		...
		*/
		...
		enemy_9 =  new createSingleFlyingEnemy_1(8, game, 40 * 16, 50 * 16); //test
		enemy_10 =  new createSingleFlyingEnemy_1(9, game, 50 * 16, 60 * 16); //test
		enemy_10 =  new createSingleFlyingEnemy_1(10, game, 60 * 16, 70 * 16); //test
		enemy_11 =  new createSingleFlyingEnemy_1(11, game, 70 * 16, 80 * 16); //test
		enemy_12 =  new createSingleFlyingEnemy_1(12, game, 80 * 16, 90 * 16); //test
